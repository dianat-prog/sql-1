...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT edad) AS total_edades_distintas FROM usuarios_lenguajes WHERE lenguaje = 'Java';
...
SELECT nombre, COUNT(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND lenguaje <> ''
GROUP BY nombre HAVING COUNT(lenguaje) > 0;
...
-- Tu respuesta aquí
SELECT COUNT(DISTINCT lenguaje) AS diferentes_lenguajes FROM usuarios_lenguajes WHERE edad > 25;

-- Ejercicio 25: Seleccionar los usuarios que tienen exactamente la misma edad.
-- Tu respuesta aquí
SELECT nombre, apellido, edad FROM usuarios_lenguajes WHERE edad IN ( SELECT edad     FROM usuarios_lenguajes
    GROUP BY edad     HAVING COUNT(*) > 1 );


-- Ejercicio 26: Encontrar el usuario con el lenguaje con mayor número de carácteres y que tenga una edad menor de 30 años. 
-- Tu respuesta aquí
SELECT nombre, apellido, edad, lenguaje FROM usuarios_lenguajes WHERE edad < 30 ORDER BY LENGTH(lenguaje) DESC LIMIT 1;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND lenguaje <> '' ORDER BY lenguaje;
...
-- Tu respuesta aquí
SELECT nombre, apellido, edad, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) AS diferencia FROM usuarios_lenguajes;
...
-- Tu respuesta aquí
SELECT *, LENGTH(nombre)as longitud_nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND lenguaje <> '';
